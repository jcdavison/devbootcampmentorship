class User < ActiveRecord::Base
  attr_accessible :first_name, :last_name, :email, :pic, :role, :contact_phone, :contact_email, :twitter, :linkedin, :interests, :passions, :location, :company, :repo, :employment_agreement
